...
@include('includes.adminSiderbar')
...
<!-- ============================================================== -->
    ...
    <script src="{{ URL::asset('js/app.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ URL::asset('js/jquery-jvectormap-us-aea-en.js') }}"></script>
    <!-- Chart JS -->
